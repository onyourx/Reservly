...
`);
  ...
  for (const stmt of [
    ...
    "ALTER TABLE sessions ADD COLUMN online INTEGER NOT NULL DEFAULT 0",
    "ALTER TABLE products ADD COLUMN online INTEGER NOT NULL DEFAULT 0",
    "ALTER TABLE bookings ADD COLUMN meeting_url TEXT NOT NULL DEFAULT ''",
